...
### Changed
- Unmapped cities and categories no longer cause a hard abort; the tool now warns and continues, writing `"Unknown"` for any value not found in the mapping files.
...
[2.1.0]: https://github.com/usporedicijene/uc-preprocessing/compare/v2.0.1...v2.1.0
